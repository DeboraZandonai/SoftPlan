...
import { FormContainer, Group, Label, Field, Button } from "./styles";
...
export default function Form({ country, edit }) {
  ...
  const submit = (event) => {
    const edited = {
      ...country,
      nameTranslations: [
        { ...country.nameTranslations[0], value: fields.name },
      ],
      flag: { ...flag, svgFile: fields.flag },
      topLevelDomains: [
        { ...topLevelDomains[0], name: fields.topLevelDomains },
      ],
  ...
  const formModel = [
    {
      label: "Bandeira",
      attrs: { name: "flag", type: "text", value: fields.flag },
    },
    {
      label: "Nome",
      attrs: { name: "name", type: "text", value: fields.name },
    },
    {
      label: "Capital",
      attrs: { name: "capital", type: "text", value: fields.capital },
    },
    {
      label: "Área km²",
      attrs: { name: "area", type: "number", value: fields.area },
    },
    {
      label: "População",
      attrs: { name: "population", type: "number", value: fields.population },
    },
    {
